    ...
    public partial class Form1 : Form
    {
        ...
        private void btnInsertSort_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i < lista.Count; i++)
            {
                ...
                // Przesuwanie większych elementów o jedno miejsce w prawo
